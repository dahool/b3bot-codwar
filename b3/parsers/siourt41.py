...
#----------------------------------------------------------------------------------------------------------------------------------------------
class Siourt41Parser(b3.parsers.iourt41.Iourt41Parser):
  gameName = 'iourt41'

  def startup(self):
    super(Siourt41Parser, self).startup() #call the parser startup()
  ...
  def getLineParts(self,  line):
    m = super(Siourt41Parser, self).getLineParts(line)
    if not m:
      return False
